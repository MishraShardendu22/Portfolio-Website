export const navLinks = [
    ...
    },
    {
      id: 5,
      name: 'Resume',
      href: 'https://drive.google.com/drive/folders/16fyjNBDsZJjmbntLVKH9qwcYXYhD4rwj?usp=drive_link',
    },
  ];
  ...
  export const myProjects = [
    ...
    },
    {
      ...
      desc: 'This is my first Docker project, aimed at learning how Docker works. It\'s a simple landing page that navigates to my project and main GitHub account.',
      subdesc: 'Explore Docker fundamentals, containerization, and key features of Docker for developing scalable and portable applications.',
      href: 'https://hub.docker.com/r/shardendumishra22/projectdocker',
      logoStyle: {
        backgroundColor: '#2496ED',
        border: '0.2px solid #1679D6',
        boxShadow: '0px 0px 60px 0px #2496ED4D',
      },
      tags: [
        { id: 1, name: 'Docker', path: '/assets/docker.svg' },
        { id: 2, name: 'Linux', path: '/assets/linux.svg' },
        { id: 3, name: 'DevOps', path: '/assets/devops.svg' },
      ],
    },
    {
      title: 'Cloudinary SaaS Application',
      desc: 'This web app allows users to upload and manage images and videos effortlessly, with image resizing for social media and Cloudinary AI for video processing.',
      subdesc: 'Empower users with advanced image and video processing, built with modern tech including Next.js, TypeScript, Tailwind CSS, and Cloudinary AI.',
      href: 'https://cloudianry-saas.vercel.app',
      logoStyle: {
        backgroundColor: '#F0DB4F',
        border: '0.2px solid #D3B047',
        boxShadow: '0px 0px 60px 0px #F0DB4F4D',
      },
      tags: [
        { id: 1, name: 'Next.js', path: '/assets/next.svg' },
        { id: 2, name: 'TypeScript', path: '/assets/typescript.svg' },
        { id: 3, name: 'Tailwind CSS', path: '/assets/tailwind.svg' },
        { id: 4, name: 'Prisma', path: '/assets/prisma.svg' },
        { id: 5, name: 'Neon', path: '/assets/neon.svg' },
        { id: 6, name: 'Cloudinary', path: '/assets/cloudinary.svg' },
        { id: 7, name: 'Clerk', path: '/assets/clerk.svg' },
      ],
    },
    {
      title: 'Intro Page - Shardendu Mishra',
      desc: 'A personal introduction page built using HTML, CSS, and JavaScript, showcasing key information about myself in a clean and minimalist design.',
      subdesc: 'Fully responsive design with interactive elements, providing a digital business card experience with dynamic user interaction.',
      href: 'https://intro-name-shardendu-mishra.netlify.app/',
      logoStyle: {
        backgroundColor: '#E44D26',
        border: '0.2px solid #D14836',
        boxShadow: '0px 0px 60px 0px #E44D264D',
      },
      tags: [
        { id: 1, name: 'HTML5', path: '/assets/html.svg' },
        { id: 2, name: 'CSS3', path: '/assets/css.svg' },
        { id: 3, name: 'JavaScript', path: '/assets/javascript.svg' },
      ],
    },
    {
      title: 'NextJS Authentication',
      desc: 'A full-stack Next.js project focusing on user authentication, showcasing user registration, login, logout, and email verification.',
      subdesc: 'This project demonstrates front-end and back-end integration using Next.js, with testing of API endpoints through Postman.',
      href: 'https://nextauth-git-main-shardendu-mishra.vercel.app/',
      logoStyle: {
        backgroundColor: '#0070F3',
        border: '0.2px solid #0057A6',
        boxShadow: '0px 0px 60px 0px #0070F34D',
      },
      tags: [
        { id: 1, name: 'Next.js', path: '/assets/next.svg' },
        { id: 2, name: 'MongoDB Atlas', path: '/assets/mongodb.svg' },
        { id: 3, name: 'TypeScript', path: '/assets/typescript.svg' },
        { id: 4, name: 'Tailwind CSS', path: '/assets/tailwind.svg' },
        { id: 5, name: 'Shadcn', path: '/assets/shadcn.svg' },
      ],
    },
    {
      title: 'Mishra Music Academy',
      desc: 'A Next.js project focused on building a music academy website, exploring UI components with Tailwind UI.',
      subdesc: 'This project emphasizes design aesthetics and UI component integration, laying the groundwork for future backend development.',
      href: 'https://mishra-music-academy-delta.vercel.app/',
      logoStyle: {
        backgroundColor: '#4B8BBE',
        border: '0.2px solid #3A7B9D',
        boxShadow: '0px 0px 60px 0px #4B8BBE4D',
      },
      tags: [
        { id: 1, name: 'Next.js', path: '/assets/next.svg' },
        { id: 2, name: 'TypeScript', path: '/assets/typescript.svg' },
    ...
    },
    {
      ...
      desc: 'This repo showcases various projects where I\'ve explored and implemented JavaScript with the DOM (Document Object Model).',
      subdesc: 'Dive in to explore interactive web applications, dynamic content manipulation, and more!',
      href: 'https://main-shardendumishra.netlify.app/',
      logoStyle: {
        backgroundColor: '#F7DF1E',
        border: '0.2px solid #E4C20D',
        boxShadow: '0px 0px 60px 0px #F7DF1E4D',
      },
      tags: [
...
export const workExperiences = [
  {
    ...
    link : 'https://github.com/ShardenduMishra22/dev-intern'
  },
  {
    id: 2,
    ...
    link : 'https://github.com/Velocity-IIITDWD/'
  },
];
